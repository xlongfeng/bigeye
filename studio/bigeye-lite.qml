...
ApplicationWindow {
    ...
    Component.onCompleted: {
        addLauncher("Supervisor Lite", "Watch testing process and machine running state", Qt.resolvedUrl("images/supervisor.png"), Qt.resolvedUrl("SupervisorLiteActivity.qml"));
