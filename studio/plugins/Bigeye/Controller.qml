...
Item {
    ...
    property ListModel systemInfoHistoryModel: ListModel {
        ...
        ListElement {
            name: "CPU0"
            color: "red"
            values: "11, 10, 10, 10, 20, 30, 20, 30, 25, 22, 30, 28, 40, 50, 60, 20, 20, 20, 20, 30, 10, 5, 40, 80, 0"
        }
        ListElement {
            name: "CPU1"
            color: "yellow"
            values: "20, 20, 30, 10, 20, 30, 80, 30, 25, 100, 30, 58, 40, 50, 60, 30, 30, 10, 10, 70, 10, 50, 60, 80, 90"
        }
        ListElement {
            name: "MEMORY"
            color: "magenta"
            values: "50, 50, 30, 10, 60, 70, 80, 40, 25, 0, 30, 58, 60, 70, 80, 90, 30, 80, 10, 20, 50, 65, 70, 90, 10"
        }
        ListElement {
            name: "DISK"
            color: "lime"
            values: "90, 90, 80, 75, 65, 50, 40, 30, 20, 30, 40, 50, 65, 75, 80, 90, 60, 10, 30, 40, 20, 25, 0, 40, 10"
        }
    }
